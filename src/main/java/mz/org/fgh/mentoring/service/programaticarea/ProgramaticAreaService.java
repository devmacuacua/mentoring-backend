...
public class ProgramaticAreaService {
    ...
    public ProgramaticAreaService(ProgramaticAreaRepository programaticAreaRepository,UserRepository userRepository) {
    ...
    public ProgrammaticArea updateProgrammaticArea(final ProgrammaticArea programaticArea, Long userId){
        User user = userRepository.findById(userId).get();
        programaticArea.setUpdatedBy(user.getUuid());
        programaticArea.setUpdatedAt(DateUtils.getCurrentDate());
